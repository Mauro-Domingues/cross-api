    ...
    return this.fileManager.checkAndCreateMultiFile([
      [
        [
          ...
          'Create'.concat(this.names.upperModuleName, 'Controller.spec.ts'),
        ],
      ...
      [
        [
          ...
          'services',
          'create'.concat(this.names.upperModuleName),
          'Create'.concat(this.names.upperModuleName, 'Service.spec.ts'),
        ],
      ...
      [
        [
          ...
          'Delete'.concat(this.names.upperModuleName, 'Controller.spec.ts'),
        ],
      ...
      [
        [
          ...
          'services',
          'delete'.concat(this.names.upperModuleName),
          'Delete'.concat(this.names.upperModuleName, 'Service.spec.ts'),
        ],
      ...
      [
        [
          ...
          'List'.concat(this.names.upperModuleName, 'Controller.spec.ts'),
        ],
      ...
      [
        [
          ...
          'services',
          'list'.concat(this.names.upperModuleName),
          'List'.concat(this.names.upperModuleName, 'Service.spec.ts'),
        ],
      ...
      [
        [
          ...
          'Show'.concat(this.names.upperModuleName, 'Controller.spec.ts'),
        ],
      ...
      [
        [
          ...
          'services',
          'show'.concat(this.names.upperModuleName),
          'Show'.concat(this.names.upperModuleName, 'Service.spec.ts'),
        ],
      ...
      [
        [
          ...
          'Update'.concat(this.names.upperModuleName, 'Controller.spec.ts'),
        ],
      ...
      [
        [
          ...
          'services',
          'update'.concat(this.names.upperModuleName),
          'Update'.concat(this.names.upperModuleName, 'Service.spec.ts'),
        ],
