...
export class CreateRoute extends BaseTemplateModule {
  ...
  public execute(): string {
    return `import { Create${this.names.upperModuleName}Controller } fr\u006Fm '@modules/${this.baseNames.pluralLowerModuleName}/services/create${this.names.upperModuleName}/Create${this.names.upperModuleName}Controller';
