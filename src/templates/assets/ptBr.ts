  ...
  public constructor() {
    this.messages = {
      ...
      mappers: {
        description: {
          mapAndClone:
            'CLONE VALUES -> Recebe como parâmetro um array de chaves e outro objeto do tipo unknown, retorna um array de objetos com o mesmo valor, é útil para consultas find WHERE + OR.',
          mapAndPatch:
