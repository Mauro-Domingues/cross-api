...
class MakeThirdLayer {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(0, fs_1.existsSync)((0, path_1.resolve)('src', 'utils', 'createNormalizeQueryLink.ts'))) {
                (0, fs_1.appendFileSync)((0, path_1.resolve)('src', 'utils', 'createNormalizeQueryLink.ts'), this.createNormalizeQueryLink.execute());
            }
            else {
                (0, fs_1.truncateSync)((0, path_1.resolve)('src', 'utils', 'createNormalizeQueryLink.ts'));
                (0, fs_1.appendFileSync)((0, path_1.resolve)('src', 'utils', 'createNormalizeQueryLink.ts'), this.createNormalizeQueryLink.execute());
            }
