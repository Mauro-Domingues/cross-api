...
export class MakeMailProvider {
    ...
    async execute() {
        ...
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider'))) {
            mkdirSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider'));
        }
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'dtos'))) {
            mkdirSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'dtos'));
        }
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'fakes'))) {
            mkdirSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'fakes'));
        }
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations'))) {
            mkdirSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations'));
        }
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'models'))) {
            mkdirSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'models'));
        }
        appendFileSync(resolve('src', 'shared', 'container', 'providers', 'index.ts'), `import './MailProvider';\n`);
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'dtos', 'ISendMailDTO.ts'))) {
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'dtos', 'ISendMailDTO.ts'), this.createIMailDTO.execute());
        }
        else {
            truncateSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'dtos', 'ISendMailDTO.ts'));
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'dtos', 'ISendMailDTO.ts'), this.createIMailDTO.execute());
        }
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'fakes', 'FakeMailProvider.ts'))) {
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'fakes', 'FakeMailProvider.ts'), this.createFakeMail.execute());
        }
        else {
            truncateSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'fakes', 'FakeMailProvider.ts'));
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'fakes', 'FakeMailProvider.ts'), this.createFakeMail.execute());
        }
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations', 'EtherealMailProvider.ts'))) {
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations', 'EtherealMailProvider.ts'), this.createEtherealMail.execute());
        }
        else {
            truncateSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations', 'EtherealMailProvider.ts'));
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations', 'EtherealMailProvider.ts'), this.createEtherealMail.execute());
        }
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations', 'SESMailProvider.ts'))) {
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations', 'SESMailProvider.ts'), this.createSESMail.execute());
        }
        else {
            truncateSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations', 'SESMailProvider.ts'));
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'implementations', 'SESMailProvider.ts'), this.createSESMail.execute());
        }
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'models', 'IMailProvider.ts'))) {
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'models', 'IMailProvider.ts'), this.createIMail.execute());
        }
        else {
            truncateSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'models', 'IMailProvider.ts'));
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'models', 'IMailProvider.ts'), this.createIMail.execute());
        }
        if (!existsSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'index.ts'))) {
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'index.ts'), this.createMailIndex.execute());
        }
        else {
            truncateSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'index.ts'));
            appendFileSync(resolve('src', 'shared', 'container', 'providers', 'MailProvider', 'index.ts'), this.createMailIndex.execute());
        }
