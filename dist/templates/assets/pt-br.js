...
exports.PortugueseMessages = void 0;
class PortugueseMessages {
    constructor() {
        this.messages = {
            ...
            devDependencies: '====={ Instalando Dependências de Desenvolvimento }=====',
            ...
            migrationGenerate: 'É utilizado para gerar ou atualizar migrações                              ',
            migrationRun: 'É utilizado para rodar as migrações                                        ',
            structure: 'CRIAÇÃO DA ESTRUTURA',
            makeApi: 'É utilizado para gerar a estrutura da sua API                              ',
            makeModule: 'É utilizado para gerar um CRUD completo de um módulo independente          ',
            ...
            mapAndUpdate: 'PUT OBJECT -> Recebe como parâmetro uma entidade e um objeto, mapeia o objeto e retorna a entidade com as propriedades atualizadas. Considera valores vazios enviados mas propriedades não pertencentes ao tipo da entidade são descartadas.',
            mapAndPatchString: 'PATCH STRINGIFIED OBJECT -> Recebe como parâmetro um objeto em formato de string e outro objeto, converte, mapeia, e retorna o objeto em formato de string com as propriedades corrigidas. Propriedades vazias ou não pertencentes ao tipo da entidade são descartadas.',
            mapAndUpdateString: 'PUT STRINGIFIED OBJECT -> Recebe como parâmetro um objeto em formato de string e outro objeto, converte, mapeia, e retorna o objeto em formato de string com as propriedades atualizadas. Considera valores vazios enviados, mas as propriedades que não pertencem ao tipo de entidade são descartadas.',
        };
    }
    execute() {
